                ...
                <div className="col-sm-4 col-md-4 text-center">
                    ...
                    <div className="col-sm-4 col-md-4 text-center">
                        ...
                        <Form inline>
                            ...
                            <div className="d-inline-block">
                                <Button type="submit" id="joinbutton">Join Newsletter</Button>
                            </div>
                        </Form>
                        <div style={{marginTop: '10px'}}>
                            <FontAwesomeIcon icon={faFacebookF} size="2x" style={{ color: '#c32aa3', marginRight: '10px' }} />
                            <FontAwesomeIcon icon={faInstagram} size="2x" style={{ color: '#c32aa3', marginRight: '10px' }}/>
                            <FontAwesomeIcon icon={faTwitter} size="2x" style={{ color: '#1da1f2', marginRight: '10px' }} />
                        </div>
                    </div>
